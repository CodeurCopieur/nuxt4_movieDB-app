<template>
  <header class="fixed header">
    <nav
      class="nav lg:w-20 w-screen lg:min-w-0 h-16 min-h-0 lg:min-h-screen text-white-500 flex justify-center items-center">
      <ul class="flex flex-row lg:flex-col lg:p-0 py-4">
        <li class="lg:my-5 mx-5">
