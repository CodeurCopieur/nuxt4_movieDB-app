    ...
    <div class="container max-w-screen-lg max-w-screen-xl lg:max-w-7xl mx-auto md:py-12 py-8 px-6">
      ...
      <nav class="flex justify-start md:mb-4 mb-6 text-sm">
        <ul class="flex flex-wrap flex-row gap-2.5 md:gap-4 ">
          <li class="pr-2">
            <NuxtLink class="border-b-2" to="/" aria-label="Accueil">Accueil</NuxtLink>
          </li>
          <li class="pr-2">
            <NuxtLink class="border-b-2" to="/movie" aria-label="Films">Movie</NuxtLink>
          </li>
          <li class="pr-2">
            <NuxtLink class="border-b-2" to="/tv" aria-label="Séries TV">Séries TV</NuxtLink>
          </li>
          <li class="pr-2">
            <NuxtLink class="border-b-2" to="/search" aria-label="Recherche">Recherche</NuxtLink>
          </li>
          <li>
            <NuxtLink class="border-b-2" to="/genres" aria-label="Genres">Genres</NuxtLink>
          </li>
        </ul>
      </nav>
      <nav class="flex justify-end text-sm">
        <ul class="flex flex-wrap md:flex-nowrap flex-row gap-2.5 md:gap-4 ">
          <li>
            <NuxtLink class="border-b-2" to="https://twitter.com/CodeurCopieur" target="_blank" aria-label="Twitter">
              Twitter</NuxtLink>
          </li>
          <li class="border-l-2 md:pl-4  pl-2">
            <NuxtLink class="border-b-2" to="https://github.com/CodeurCopieur" target="_blank" aria-label="Github">
              Github</NuxtLink>
          </li>
        </ul>
      </nav>
